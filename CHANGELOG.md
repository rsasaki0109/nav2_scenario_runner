...
- Add an OSS Lichtblick capture path for the README hero: a pinned viewer container, committed Nav2 layout, software-WebGL browser recording, and a Jazzy + `gz sim` one-command orchestrator that times a real attach-mode goal for the GIF.
